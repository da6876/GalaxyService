...
<head>
    ...
    <title>Samara International - Admin Login</title>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{url('/adminLogIn')}}" method="post">
                                    ...
                                    <div class="form-group"><label class="small mb-1">Email</label>
                                        <input class="form-control py-4" type="text" placeholder="Enter User Name" name="userName"/>
                                    </div>
                                    <div class="form-group"><label class="small mb-1" >Password</label>
                                        <input class="form-control py-4" type="password" placeholder="Enter password" name="userPassword"/></div>
