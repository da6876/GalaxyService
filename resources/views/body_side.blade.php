...
<section class="hero-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="hero-text">
                    <h1>Galaxy Service</h1>
                    <p>Here are the best AC,Freige including recommendations for international
    ...
    <div class="hero-slider owl-carousel">
        ...
        <div class="hs-item set-bg" data-setbg="{{asset('public/img/hero/hero-2.jpg')}}"></div>
        <div class="hs-item set-bg" data-setbg="{{asset('public/img/hero/hero-3.jpg')}}"></div>
    </div>
</section>
<!-- Hero Section End -->
        ...
        <div class="hp-room-items">
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="hp-room-item set-bg" data-setbg="{{asset('public/img/room/room-b1.jpg')}}">
                        <div class="hr-text">
                            <h3>Double Room</h3>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="hp-room-item set-bg" data-setbg="{{asset('public/img/room/room-b2.jpg')}}">
                        <div class="hr-text">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="hp-room-item set-bg" data-setbg="{{asset('public/img/room/room-b3.jpg')}}">
                        <div class="hr-text">
                            <h3>Deluxe Room</h3>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="hp-room-item set-bg" data-setbg="{{asset('public/img/room/room-b4.jpg')}}">
                        <div class="hr-text">
                            <h3>Family Room</h3>
